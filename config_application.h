...
#define demoUseShared cfgFalse

#define ms_tick(time) ((uint16_t)((950UL*time)/1000UL))
...
#define  StackSafety                             20
#define  StackSizeOS                             100 + 8*defThreeByteStackAdd
#define  StackSizeISR                            0
#if (demoUseShared == cfgTrue)
  #define  StackSizeShared                       6 + 2*defThreeByteStackAdd
  #define  StackSizeOverride                     cfgShared
#else
  #define  StackSizeShared                       10
  #define  StackSizeOverride                     50 + 2*defThreeByteStackAdd
#endif
